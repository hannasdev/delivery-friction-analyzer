...
| Review comments | comment ID, author, path, line, timestamps, URL | REST `GET /repos/{owner}/{repo}/pulls/{number}/comments` and GraphQL review threads | REST is good for individual comments; GraphQL is required for thread grouping. |
