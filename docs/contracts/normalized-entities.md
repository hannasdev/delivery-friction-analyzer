...
- `PullRequest`: source IDs, author login when known, URL, state, lifecycle timestamps, final diff shape, PR-open diff source confidence, files, reviews, review threads, comments, checks, and workflow-run coverage.
